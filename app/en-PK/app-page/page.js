...
export const metadata = {
  ...
  alternates: { canonical: 'https://u7777.net.pk/en-PK/app' },
}
        ...
        <div className="page-content">
          ...
          <div className="related-pages" style={{ marginTop: '48px' }}>
            ...
            <div className="related-grid">
              {[['APK Guide', '/en-PK/apk'], ['iOS Guide', '/en-PK/ios'], ['PC Guide', '/en-PK/pc'], ['How to Play', '/en-PK/how-to-play'], ['Login', '/en-PK/login'], ['Register', '/en-PK/register']].map(([label, href]) => (
