...
export const metadata = {
  ...
  alternates: { canonical: 'https://u7777.net.pk/en-PK/legit' },
}
      ...
      <div className="container" style={{ paddingBottom: '72px' }}>
        ...
        <div className="page-content">
          ...
          <div style={{ marginTop: '40px', display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
            ...
            <Link href="/en-PK/review" className="btn btn-outline">Read Full Review</Link>
          </div>
          <div className="related-pages" style={{ marginTop: '48px' }}>
            ...
            <div className="related-grid">
              {[['Review', '/en-PK/review'], ['FAQ', '/en-PK/faq'], ['Alternatives', '/en-PK/alternatives'], ['Contact', '/en-PK/contact'], ['Troubleshooting', '/en-PK/troubleshooting'], ['About', '/en-PK/about']].map(([label, href]) => (
