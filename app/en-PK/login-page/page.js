...
export const metadata = {
  ...
  alternates: { canonical: 'https://u7777.net.pk/en-PK/login' },
}
        ...
        <div className="page-content">
          ...
          <div className="related-pages" style={{ marginTop: '48px' }}>
            ...
            <div className="related-grid">
              {[['Register', '/en-PK/register'], ['Forgot Password', '/en-PK/forgot-password'], ['App Download', '/en-PK/app-page'], ['Deposit', '/en-PK/deposit'], ['Troubleshooting', '/en-PK/troubleshooting'], ['FAQ', '/en-PK/faq']].map(([label, href]) => (
