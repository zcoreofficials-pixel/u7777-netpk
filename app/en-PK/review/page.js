...
export const metadata = {
  ...
  alternates: { canonical: 'https://u7777.net.pk/en-PK/review' },
}
      ...
      <div className="container" style={{ paddingBottom: '72px' }}>
        ...
        <div className="page-content">
          ...
          <div style={{ marginTop: '40px', display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
            ...
            <Link href="/en-PK/legit" className="btn btn-outline">Is It Legit?</Link>
          </div>
          <div className="related-pages" style={{ marginTop: '48px' }}>
            ...
            <div className="related-grid">
              {[['Is It Legit?', '/en-PK/legit'], ['Alternatives', '/en-PK/alternatives'], ['Bonus', '/en-PK/bonus'], ['How to Play', '/en-PK/how-to-play'], ['FAQ', '/en-PK/faq'], ['Contact', '/en-PK/contact']].map(([label, href]) => (
