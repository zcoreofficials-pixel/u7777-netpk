...
export const metadata = {
  ...
  alternates: { canonical: 'https://u7777.net.pk/en-PK/U7777-game-download' },
}
      ...
      <div className="container" style={{ paddingBottom: '72px' }}>
        <div className="page-hero">
          ...
          <div style={{ display: 'flex', gap: '12px', marginTop: '24px', flexWrap: 'wrap' }}>
            ...
            <Link href="/en-PK/register" className="btn btn-primary">Create Account</Link>
          </div>
        </div>
        <div className="page-content">
          ...
          <div style={{ marginTop: '40px', display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
            ...
            <Link href="/en-PK/register" className="btn btn-primary">Register Now</Link>
          </div>
          <div className="related-pages" style={{ marginTop: '48px' }}>
            ...
            <div className="related-grid">
              {[['APK Guide', '/en-PK/apk'], ['iOS Guide', '/en-PK/ios'], ['PC Guide', '/en-PK/pc'], ['How to Play', '/en-PK/how-to-play'], ['Login', '/en-PK/U7777-Login'], ['Register', '/en-PK/register']].map(([label, href]) => (
