...
export const metadata = {
  ...
  alternates: { canonical: 'https://u7777.net.pk/en-PK/troubleshooting' },
}
      ...
      <div className="container" style={{ paddingBottom: '72px' }}>
        ...
        <div className="page-content" style={{ maxWidth: '100%' }}>
          ...
          <div style={{ marginTop: '40px', display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
            <Link href="/en-PK/contact" className="btn btn-primary">Contact Support</Link>
            <Link href="/en-PK/faq" className="btn btn-outline">View FAQ</Link>
          </div>
