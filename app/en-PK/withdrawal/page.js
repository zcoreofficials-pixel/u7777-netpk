...
export const metadata = {
  ...
  alternates: { canonical: 'https://u7777.net.pk/en-PK/withdrawal' },
}
      ...
      <div className="container" style={{ paddingBottom: '72px' }}>
        <div className="page-hero">
          ...
          <div style={{ display: 'flex', gap: '12px', marginTop: '24px', flexWrap: 'wrap' }}>
            ...
            <Link href="/en-PK/deposit" className="btn btn-outline">Deposit Guide</Link>
          </div>
        </div>
        <div className="page-content">
          ...
          <div style={{ marginTop: '40px', display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
            <Link href="/go" className="btn btn-primary">Withdraw Now</Link>
            <Link href="/en-PK/troubleshooting" className="btn btn-outline">Fix Withdrawal Issues</Link>
          </div>
          <div className="related-pages" style={{ marginTop: '48px' }}>
            ...
            <div className="related-grid">
              {[['Deposit', '/en-PK/deposit'], ['Bonus', '/en-PK/bonus'], ['Verification', '/en-PK/verification'], ['Troubleshooting', '/en-PK/troubleshooting'], ['FAQ', '/en-PK/faq'], ['Contact', '/en-PK/contact']].map(([label, href]) => (
