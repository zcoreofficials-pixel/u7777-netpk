...
export const metadata = {
  ...
  alternates: { canonical: 'https://u7777.net.pk/u7777-tricks' },
}
        ...
        <div className="page-content">
          ...
          <div className="related-pages" style={{ marginTop: '48px' }}>
            ...
            <div className="related-grid">
              {[['How to Play', '/u7777-how-to-play'], ['Casino Games', '/u7777-casino'], ['Bonus', '/u7777-bonus'], ['Review', '/u7777-review'], ['FAQ', '/u7777-faq'], ['Deposit', '/u7777-deposit']].map(([label, href]) => (
