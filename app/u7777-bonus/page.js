...
export const metadata = {
  ...
  alternates: { canonical: 'https://u7777.net.pk/u7777-bonus' },
}
      ...
      <div className="container" style={{ paddingBottom: '72px' }}>
        <div className="page-hero">
          ...
          <div style={{ display: 'flex', gap: '12px', marginTop: '24px', flexWrap: 'wrap' }}>
            ...
            <Link href="/u7777-promo" className="btn btn-outline">Promo Codes</Link>
          </div>
        </div>
        <div className="page-content">
          ...
          <div style={{ marginTop: '40px', display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
            ...
            <Link href="/u7777-deposit" className="btn btn-outline">How to Deposit</Link>
          </div>
          <div className="related-pages" style={{ marginTop: '48px' }}>
            ...
            <div className="related-grid">
              {[['Promo Codes', '/u7777-promo'], ['Referral Program', '/u7777-referral'], ['Deposit', '/u7777-deposit'], ['How to Play', '/u7777-how-to-play'], ['VIP Review', '/u7777-review'], ['FAQ', '/u7777-faq']].map(([label, href]) => (
