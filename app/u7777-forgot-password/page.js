...
export const metadata = {
  ...
  alternates: { canonical: 'https://u7777.net.pk/u7777-forgot-password' },
}
export default function ForgotPasswordPage() {
  ...
  return (
    <>
      <Header lang="en-PK" />
      <div className="container"><div className="breadcrumb"><Link href="/en-PK">Home</Link> <span>›</span> <Link href="/u7777-login">Login</Link> <span>›</span> Forgot Password</div></div>
