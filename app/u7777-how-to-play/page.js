...
export const metadata = {
  ...
  alternates: { canonical: 'https://u7777.net.pk/u7777-how-to-play' },
}
      ...
      <div className="container" style={{ paddingBottom: '72px' }}>
        <div className="page-hero">
          ...
          <div style={{ display: 'flex', gap: '12px', marginTop: '24px', flexWrap: 'wrap' }}>
            ...
            <Link href="/u7777-download" className="btn btn-download">Download App</Link>
          </div>
        </div>
        <div className="page-content">
          ...
          <div style={{ marginTop: '40px', display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
            ...
            <Link href="/u7777-tricks" className="btn btn-outline">Tips and Tricks</Link>
          </div>
          <div className="related-pages" style={{ marginTop: '48px' }}>
            ...
            <div className="related-grid">
              {[['Casino Games', '/u7777-casino'], ['Tips & Tricks', '/u7777-tricks'], ['Deposit', '/u7777-deposit'], ['Bonus', '/u7777-bonus'], ['Review', '/u7777-review'], ['FAQ', '/u7777-faq']].map(([label, href]) => (
