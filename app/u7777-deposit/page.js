...
export const metadata = {
  ...
  alternates: { canonical: 'https://u7777.net.pk/u7777-deposit' },
}
      ...
      <div className="container" style={{ paddingBottom: '72px' }}>
        <div className="page-hero">
          ...
          <div style={{ display: 'flex', gap: '12px', marginTop: '24px', flexWrap: 'wrap' }}>
            ...
            <Link href="/u7777-withdrawal" className="btn btn-outline">Withdrawal Guide</Link>
          </div>
        </div>
        <div className="page-content">
          ...
          <div style={{ marginTop: '40px', display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
            <Link href="/go" className="btn btn-primary">Deposit Now</Link>
            <Link href="/u7777-bonus" className="btn btn-outline">View All Bonuses</Link>
          </div>
          <div className="related-pages" style={{ marginTop: '48px' }}>
            ...
            <div className="related-grid">
              {[['Withdrawal', '/u7777-withdrawal'], ['Bonus', '/u7777-bonus'], ['Promo Codes', '/u7777-promo'], ['Referral', '/u7777-referral'], ['Troubleshooting', '/u7777-troubleshooting'], ['FAQ', '/u7777-faq']].map(([label, href]) => (
