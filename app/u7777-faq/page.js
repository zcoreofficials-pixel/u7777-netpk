...
export const metadata = {
  ...
  alternates: { canonical: 'https://u7777.net.pk/u7777-faq' },
}
      ...
      <div className="container" style={{ paddingBottom: '72px' }}>
        ...
        <div className="page-content" style={{ maxWidth: '100%' }}>
          ...
          <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
            ...
            <Link href="/u7777-contact" className="btn btn-outline">Contact Support</Link>
          </div>
          <div className="related-pages" style={{ marginTop: '48px' }}>
            ...
            <div className="related-grid">
              {[['Troubleshooting', '/u7777-troubleshooting'], ['Contact', '/u7777-contact'], ['App Download', '/u7777-download'], ['Deposit', '/u7777-deposit'], ['Withdrawal', '/u7777-withdrawal'], ['Bonus', '/u7777-bonus']].map(([label, href]) => (
